...
## Modeling and Inference:
	Since we are primarily looking at chronological data of MAP in relation to multiple indicators of health, we decided to plot MAP vs year and different demographics: ethnicity, gender, age. FINISH ANALYSIS TO COMPLETE THIS SECTION.\n
...
year_facet <- age_plot + facet_wrap( ~ Year, ncol=4)+
  labs(title = "Mean Arterial Pressure (MAP) vs. Age by Years", 
