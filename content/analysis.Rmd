...
We use root-mean-square error (RMSE) and R-squared (R2) to evaluate model performance. We compare predictions of MAP based on independent variables to the real MAP values in the testing set to see how well the model fits. The results of RMSE and R2 are shown below. 
...
The RMSE and R2 results of this model are shown below. 
